...
import com.example.ba_hung.findyardgolf.ui.adapter.DichVuAdapter;
...
public class DichVuFragment extends Fragment {
    ...
    public DichVuFragment(SanGolfModel sanGolf) {
        // Required empty public constructor
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_dich_vu, container, false);
        return  mView;
    }
    ...
    private void suDungReCyClerView() {
        DichVuAdapter adapter = new DichVuAdapter(getActivity(), tenDichVuThat);
